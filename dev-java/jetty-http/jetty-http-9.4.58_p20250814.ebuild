...
DESCRIPTION="HTTP implementation library for Eclipse Jetty"
...
JAVA_RESOURCE_DIRS="jetty-http/src/main/resources"
JAVA_SRC_DIR="jetty-http/src/main/java"
