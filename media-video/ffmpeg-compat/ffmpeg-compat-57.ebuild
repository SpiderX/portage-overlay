...
DESCRIPTION="Compatibility package for ffmpeg to provide versions 57 of libraries"
...
IUSE="alsa +encode jack oss pic sndio v4l
	${FFMPEG_FLAG_MAP[@]%:*}
	${FFMPEG_ENCODER_FLAG_MAP[@]%:*}"
...
REQUIRED_USE="libv4l? ( v4l ) ${CPU_REQUIRED_USE}"
