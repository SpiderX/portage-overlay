...
inherit dune edo elisp-common

DESCRIPTION="Context sensitive completion for OCaml in Vim and Emacs"
HOMEPAGE="https://github.com/ocaml/merlin"
SRC_URI="https://github.com/ocaml/${PN}/archive/v${PV}-503.tar.gz -> ${P}-503.tar.gz
	https://github.com/ocaml/${PN}/archive/v${PV}-504.tar.gz -> ${P}-504.tar.gz"
