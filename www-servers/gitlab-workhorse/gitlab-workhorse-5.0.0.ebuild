...
EGO_VENDOR=( "github.com/BurntSushi/toml a368813c5e648fee92e5f6c30e3944ff9d5e8895"
	...
	"github.com/jfbus/httprs 7861a11508467e8d1575182d6456065e6402d8fc"
	...
	"github.com/sebest/xff 6c115e0ffa35d6a2e3f7a9e797c9cf07f0da4b9f"
...
src_prepare() {
	...
	# don't run detect-context.sh and govendor
	sed -i \
		-e '/PREFIX=/s|/local||' \
		...
		-e '/test:/s/ govendor//' \
		-e '/_support\/detect-context.sh/d' \
		-e '/govendor sync/d' \
