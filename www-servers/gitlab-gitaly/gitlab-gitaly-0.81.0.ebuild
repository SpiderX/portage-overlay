...
# do we need this ?
	exeinto /var/lib/"${PN}"/ruby/vendor/bundle/ruby/2.3.0/gems/charlock_holmes-0.7.5/ext/charlock_holmes
	doexe ruby/vendor/bundle/ruby/2.3.0/gems/charlock_holmes-0.7.5/ext/charlock_holmes/charlock_holmes.so
	exeinto /var/lib/"${PN}"/ruby/vendor/bundle/ruby/2.3.0/gems/charlock_holmes-0.7.5/lib/charlock_holmes
	doexe ruby/vendor/bundle/ruby/2.3.0/gems/charlock_holmes-0.7.5/lib/charlock_holmes/charlock_holmes.so
