...
#	"gitlab.com/gitlab-org/gitaly-proto 8ccaaaeb92e3babf523d8f8a91d464ee42228e62"
...
src_prepare() {
	...
	# nokogumbo - https://github.com/rubys/nokogumbo/pull/5
	sed -i \
		-e '/PREFIX :=/s|/local||' \
		...
		-e '/bundle config/a\\tbundle config build.nokogumbo --with-ldflags= -Lext/nokogiri -l:nokogiri.so' \
