...
EGO_SUM=(
	...
	"cloud.google.com/go v0.92.2/go.mod"
	...
	"cloud.google.com/go/kms v1.10.2/go.mod"
	...
	"cloud.google.com/go/security v1.14.0/go.mod"
	...
	"cloud.google.com/go/spanner v1.25.0/go.mod"
	...
	"contrib.go.opencensus.io/exporter/stackdriver v0.13.8/go.mod"
	...
	"github.com/apache/beam v2.32.0+incompatible/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.44.259/go.mod"
	...
	"github.com/fullstorydev/grpcurl v1.8.2/go.mod"
	...
	"github.com/go-piv/piv-go v1.11.0/go.mod"
	...
	"github.com/google/go-attestation v0.4.4-0.20220404204839-8820d49b18d9/go.mod"
	...
	"github.com/google/go-tpm v0.3.3/go.mod"
	...
	"github.com/google/go-tpm-tools v0.3.9/go.mod"
	"github.com/google/go-tpm-tools v0.3.11"
	"github.com/google/go-tpm-tools v0.3.11/go.mod"
	...
	"github.com/google/trillian v1.4.0/go.mod"
	...
	"github.com/hashicorp/vault/api v1.9.0/go.mod"
	"github.com/hashicorp/vault/api v1.9.1"
	"github.com/hashicorp/vault/api v1.9.1/go.mod"
	"github.com/hashicorp/vault/api/auth/approle v0.4.0"
	"github.com/hashicorp/vault/api/auth/approle v0.4.0/go.mod"
	"github.com/hashicorp/vault/api/auth/kubernetes v0.4.0"
	"github.com/hashicorp/vault/api/auth/kubernetes v0.4.0/go.mod"
	...
	"github.com/jackc/pgx/v4 v4.18.0/go.mod"
	...
	"github.com/newrelic/go-agent/v3 v3.21.1/go.mod"
	...
	"github.com/pseudomuto/protoc-gen-doc v1.5.0/go.mod"
	...
	"github.com/smallstep/go-attestation v0.4.4-0.20230509120429-e17291421738/go.mod"
	"github.com/smallstep/nosql v0.6.0"
	"github.com/smallstep/nosql v0.6.0/go.mod"
	"github.com/smallstep/pkcs7 v0.0.0-20230302202335-4c094085c948"
	"github.com/smallstep/pkcs7 v0.0.0-20230302202335-4c094085c948/go.mod"
	...
	"go.step.sm/cli-utils v0.7.6/go.mod"
	"go.step.sm/crypto v0.30.0"
	"go.step.sm/crypto v0.30.0/go.mod"
	"go.step.sm/linkedca v0.19.1"
	"go.step.sm/linkedca v0.19.1/go.mod"
	...
	"golang.org/x/exp v0.0.0-20230310171629-522b1b587ee0/go.mod"
	...
	"google.golang.org/api v0.121.0/go.mod"
