...
MY_PN="aws-cloudformation-template-formatter"
MY_PV="${PV//_p/-}"
MY_P="${MY_PN}-${MY_PV}"
...
EGO_SUM=(
	...
	"github.com/aws-cloudformation/rain v0.10.2"
	"github.com/aws-cloudformation/rain v0.10.2/go.mod"
	"github.com/aws/aws-sdk-go-v2 v0.27.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/config v0.2.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/credentials v0.1.2/go.mod"
	"github.com/aws/aws-sdk-go-v2/ec2imds v0.1.2/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/cloudformation v0.27.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/ec2 v0.27.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/internal/accept-encoding v0.2.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/internal/s3shared v0.2.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/s3 v0.27.0/go.mod"
	"github.com/aws/aws-sdk-go-v2/service/sts v0.27.0/go.mod"
	"github.com/awslabs/smithy-go v0.2.0/go.mod"
...
SRC_URI="https://github.com/awslabs/${MY_PN}/archive/v${MY_PV}.tar.gz -> ${MY_P}.tar.gz
	${EGO_SUM_SRC_URI}"
