...
EGO_SUM=(
	...
	"github.com/Azure/azure-sdk-for-go v57.1.0+incompatible/go.mod"
	...
	"github.com/Azure/go-autorest/autorest/azure/cli v0.4.3/go.mod"
	...
	"github.com/NaverCloudPlatform/ncloud-sdk-go-v2 v1.2.0/go.mod"
	...
	"github.com/Telmate/proxmox-api-go v0.0.0-20210402150908-b9cc6607c070/go.mod"
	"github.com/Telmate/proxmox-api-go v0.0.0-20210825163308-5e4c0d698a78"
	"github.com/Telmate/proxmox-api-go v0.0.0-20210825163308-5e4c0d698a78/go.mod"
	...
	"github.com/aliyun/alibaba-cloud-sdk-go v1.61.1244/go.mod"
	"github.com/aliyun/aliyun-oss-go-sdk v2.1.8+incompatible/go.mod"
	"github.com/aliyun/aliyun-oss-go-sdk v2.1.10+incompatible"
	"github.com/aliyun/aliyun-oss-go-sdk v2.1.10+incompatible/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.26.3/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.38.57/go.mod"
	...
	"github.com/digitalocean/go-libvirt v0.0.0-20210723161134-761cfeeb5968/go.mod"
	...
	"github.com/hashicorp/hcp-sdk-go v0.10.1-0.20210727200019-239ce8d80646/go.mod"
	...
	"github.com/hashicorp/packer-plugin-alicloud v1.0.0/go.mod"
	"github.com/hashicorp/packer-plugin-amazon v1.0.1"
	"github.com/hashicorp/packer-plugin-amazon v1.0.1/go.mod"
	"github.com/hashicorp/packer-plugin-ansible v1.0.0"
	"github.com/hashicorp/packer-plugin-ansible v1.0.0/go.mod"
	"github.com/hashicorp/packer-plugin-azure v1.0.3"
	"github.com/hashicorp/packer-plugin-azure v1.0.3/go.mod"
	"github.com/hashicorp/packer-plugin-chef v1.0.1"
	"github.com/hashicorp/packer-plugin-chef v1.0.1/go.mod"
	...
	"github.com/hashicorp/packer-plugin-converge v1.0.0/go.mod"
	...
	"github.com/hashicorp/packer-plugin-docker v1.0.1/go.mod"
	"github.com/hashicorp/packer-plugin-googlecompute v1.0.5"
	"github.com/hashicorp/packer-plugin-googlecompute v1.0.5/go.mod"
	"github.com/hashicorp/packer-plugin-hcloud v1.0.1"
	"github.com/hashicorp/packer-plugin-hcloud v1.0.1/go.mod"
	...
	"github.com/hashicorp/packer-plugin-hyperv v1.0.0/go.mod"
	"github.com/hashicorp/packer-plugin-inspec v0.0.7"
	"github.com/hashicorp/packer-plugin-inspec v0.0.7/go.mod"
	...
	"github.com/hashicorp/packer-plugin-linode v1.0.0/go.mod"
	...
	"github.com/hashicorp/packer-plugin-outscale v1.0.1/go.mod"
	...
	"github.com/hashicorp/packer-plugin-proxmox v1.0.2/go.mod"
	"github.com/hashicorp/packer-plugin-puppet v1.0.0"
	"github.com/hashicorp/packer-plugin-puppet v1.0.0/go.mod"
	"github.com/hashicorp/packer-plugin-qemu v1.0.0"
	"github.com/hashicorp/packer-plugin-qemu v1.0.0/go.mod"
	"github.com/hashicorp/packer-plugin-salt v0.0.8"
	"github.com/hashicorp/packer-plugin-salt v0.0.8/go.mod"
	"github.com/hashicorp/packer-plugin-scaleway v1.0.3"
	"github.com/hashicorp/packer-plugin-scaleway v1.0.3/go.mod"
	"github.com/hashicorp/packer-plugin-sdk v0.2.2/go.mod"
	"github.com/hashicorp/packer-plugin-sdk v0.2.3/go.mod"
	"github.com/hashicorp/packer-plugin-sdk v0.2.4/go.mod"
	...
	"github.com/hashicorp/packer-plugin-tencentcloud v1.0.1/go.mod"
	...
	"github.com/hashicorp/packer-plugin-vagrant v1.0.0/go.mod"
	"github.com/hashicorp/packer-plugin-virtualbox v1.0.0"
	"github.com/hashicorp/packer-plugin-virtualbox v1.0.0/go.mod"
	"github.com/hashicorp/packer-plugin-vmware v1.0.3"
	"github.com/hashicorp/packer-plugin-vmware v1.0.3/go.mod"
	"github.com/hashicorp/packer-plugin-vsphere v1.0.1"
	"github.com/hashicorp/packer-plugin-vsphere v1.0.1/go.mod"
	"github.com/hashicorp/packer-plugin-yandex v1.0.2"
	"github.com/hashicorp/packer-plugin-yandex v1.0.2/go.mod"
	...
	"github.com/linode/linodego v0.28.5/go.mod"
	...
	"github.com/outscale/osc-sdk-go/osc v0.0.0-20210316122053-4dfd64ce707a/go.mod"
	...
	"github.com/tencentcloud/tencentcloud-sdk-go v1.0.152/go.mod"
	"github.com/tencentcloud/tencentcloud-sdk-go v3.0.233+incompatible"
	"github.com/tencentcloud/tencentcloud-sdk-go v3.0.233+incompatible/go.mod"
	...
	"github.com/vmware/govmomi v0.26.1/go.mod"
	...
	"github.com/yandex-cloud/go-genproto v0.0.0-20210413095726-6b0dcd341e19/go.mod"
	"github.com/yandex-cloud/go-genproto v0.0.0-20210419102011-ea71516bb3f7/go.mod"
	"github.com/yandex-cloud/go-genproto v0.0.0-20210824140926-1bca7bc0c005"
	"github.com/yandex-cloud/go-genproto v0.0.0-20210824140926-1bca7bc0c005/go.mod"
	"github.com/yandex-cloud/go-sdk v0.0.0-20210413100926-1c3eb10c58d7/go.mod"
	"github.com/yandex-cloud/go-sdk v0.0.0-20210824141121-182aedd44a25"
	"github.com/yandex-cloud/go-sdk v0.0.0-20210824141121-182aedd44a25/go.mod"
	...
	"golang.org/x/mobile v0.0.0-20210220033013-bdb1ca9a1e08/go.mod"
