...
EGO_SUM=(
	...
	"github.com/ClickHouse/clickhouse-go v1.5.4/go.mod"
	"github.com/ClickHouse/clickhouse-go/v2 v2.2.0/go.mod"
	...
	"github.com/alicebob/miniredis/v2 v2.22.0/go.mod"
	"github.com/aliyun/alibaba-cloud-sdk-go v1.61.18/go.mod"
	"github.com/aliyun/alibaba-cloud-sdk-go v1.61.1402/go.mod"
	"github.com/aliyun/alibaba-cloud-sdk-go v1.61.1620"
	"github.com/aliyun/alibaba-cloud-sdk-go v1.61.1620/go.mod"
	...
	"github.com/dtm-labs/dtmdriver v0.0.5/go.mod"
	"github.com/dtm-labs/dtmdriver v0.0.6"
	"github.com/dtm-labs/dtmdriver v0.0.6/go.mod"
	"github.com/dtm-labs/dtmdriver-gozero v0.0.6"
	"github.com/dtm-labs/dtmdriver-gozero v0.0.6/go.mod"
	"github.com/dtm-labs/dtmdriver-gozero v0.0.7"
	"github.com/dtm-labs/dtmdriver-gozero v0.0.7/go.mod"
	"github.com/dtm-labs/dtmdriver-kratos v0.0.9"
	"github.com/dtm-labs/dtmdriver-kratos v0.0.9/go.mod"
	"github.com/dtm-labs/dtmdriver-polaris v0.0.5"
	"github.com/dtm-labs/dtmdriver-polaris v0.0.5/go.mod"
	"github.com/dtm-labs/dtmdriver-springcloud v1.2.3"
	"github.com/dtm-labs/dtmdriver-springcloud v1.2.3/go.mod"
	...
	"github.com/mkevac/debugcharts v0.0.0-20191222103121-ae1c48aa8615/go.mod"
	...
	"github.com/paulmach/orb v0.7.1/go.mod"
	...
	"github.com/zeromicro/go-zero v1.3.5/go.mod"
	...
	"github.com/zeromicro/zero-contrib/zrpc/registry/nacos v0.0.0-20220525162615-f10f16d580d6/go.mod"
	...
	"go.opentelemetry.io/otel/exporters/jaeger v1.8.0/go.mod"
	"go.opentelemetry.io/otel/exporters/zipkin v1.3.0/go.mod"
	"go.opentelemetry.io/otel/exporters/zipkin v1.8.0/go.mod"
	"go.opentelemetry.io/otel/sdk v1.3.0/go.mod"
	"go.opentelemetry.io/otel/sdk v1.8.0"
	"go.opentelemetry.io/otel/sdk v1.8.0/go.mod"
	...
	"google.golang.org/genproto v0.0.0-20220602131408-e326c6e8e9c8/go.mod"
	...
	"k8s.io/utils v0.0.0-20220706174534-f6158b442e7c/go.mod"
