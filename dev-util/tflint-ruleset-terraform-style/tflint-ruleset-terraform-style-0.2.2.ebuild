...
DESCRIPTION="TFLint Ruleset for Terraform coding style"
HOMEPAGE="https://github.com/Heldroe/tflint-ruleset-terraform-style"
SRC_URI="https://github.com/Heldroe/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
...
DOC_CONTENTS="You should create a symlink to tflint-ruleset-terraform-style\\n
...
src_install() {
	einstalldocs
	exeinto usr/share/tflint-ruleset/github.com/Heldroe/"${PN}"/"${PV}"
	doexe tflint-ruleset-terraform-style
