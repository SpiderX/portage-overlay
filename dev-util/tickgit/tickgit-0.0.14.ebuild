...
EGO_SUM=(
	...
	"github.com/augmentable-dev/lege v0.0.0-20191028004410-79cb985065a1/go.mod"
	...
	"github.com/go-enry/go-enry/v2 v2.5.2/go.mod"
	"github.com/go-enry/go-oniguruma v1.2.1"
	"github.com/go-enry/go-oniguruma v1.2.1/go.mod"
...
SRC_URI="https://github.com/augmentable-dev/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
