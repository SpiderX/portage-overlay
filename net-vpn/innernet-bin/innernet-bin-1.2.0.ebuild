...
SRC_URI="client? ( https://github.com/tonarino/${MY_PN}/releases/download/v${PV}/${MY_P/-/_}_amd64.deb )
	server? ( https://github.com/tonarino/${MY_PN}/releases/download/v${PV}/${MY_PN}-server_${PV}_amd64.deb )"
