...
* [![Gentoo package](https://repology.org/badge/version-only-for-repo/gentoo/opentracker.svg)](https://repology.org/metapackage/opentracker) [opentracker](http://erdgeist.org/arts/software/opentracker/) with [flygoast](https://github.com/flygoast/opentracker)'s patches ([214969](https://bugs.gentoo.org/show_bug.cgi?id=214969))
