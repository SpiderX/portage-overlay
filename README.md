...
[![Number of ebuilds: 1619](https://img.shields.io/badge/ebuild-1619-orange.svg)](https://img.shields.io/badge/ebuild-1619-orange.svg)
...
*   app-admin/[kubecm](https://github.com/sunny0826/kubecm) | Manage your kubeconfig more easily
...
*   app-admin/[oras](https://github.com/oras-project/oras) | A CLI to push and pull files from any OCI registry
...
*   app-admin/[stern](https://github.com/stern/stern) | Multi pod and container log tailing for Kubernetes
...
*   app-crypt/[lxqt-wallet](https://github.com/lxqt/lxqt_wallet) | A kwallet like functionality for lxqt
...
*   app-crypt/[transcrypt](https://github.com/elasticdog/transcrypt) | Transparently encrypt files within a git repository
...
*   app-misc/[chatgpt-desktop](https://chatgpt.com) | Desktop application for ChatGPT and Codex
...
*   app-misc/[mcommander](https://github.com/blue-panels/mcommander) | M-Commander, based on GNU Midnight Commander
...
*   app-text/[csvlens](https://github.com/YS-L/csvlens) | Command line csv viewer
...
*   dev-build/[lito](https://github.com/litocpp/lito) | Module-first C++ build tool with manifest
...
*   dev-db/[libodb](https://codesynthesis.com/products/odb/) | Common ODB runtime library
*   dev-db/[libodb-sqlite](https://codesynthesis.com/products/odb/) | ODB SQLite runtime library
...
*   dev-db/[pgaudit](https://github.com/pgaudit/pgaudit) | PostgreSQL Audit Extension
...
*   dev-haskell/[aeson-jsonpath](https://github.com/taimoorzaeem/aeson-jsonpath) | Parse and run JSONPath queries on Aeson documents
...
*   dev-haskell/[cpphs](https://github.com/haskell-pkg-janitors/cpphs) | A liberalised re-implementation of cpp, the C pre-processor
...
*   dev-haskell/[doctest-parallel](https://github.com/martijnbastiaan/doctest-parallel) | Test interactive Haskell examples
...
*   dev-haskell/[ghc-exactprint](https://github.com/alanz/ghc-exactprint) | ExactPrint for GHC
*   dev-haskell/[gitrev](https://github.com/acfoltzer/gitrev) | Compile git revision info into Haskell projects
*   dev-haskell/[haskell-src](https://github.com/haskell-pkg-janitors/haskell-src) | Support for manipulating Haskell source code
...
*   dev-haskell/[hslogger](https://github.com/haskell-hvr/hslogger) | Versatile logging framework
...
*   dev-haskell/[iso8601-time](https://github.com/nh2/iso8601-time) | Convert to/from the ISO 8601 time format
...
*   dev-haskell/[jose-jwt](https://github.com/tekul/jose-jwt) | JSON Object Signing and Encryption Library
...
*   dev-haskell/[lawful-conversions](https://github.com/nikita-volkov/lawful-conversions) | Lawful typeclasses for bidirectional conversion between types
*   dev-haskell/[lens-aeson](https://github.com/lens/lens-aeson) | Law-abiding lenses for aeson
*   dev-haskell/[list-t](https://github.com/nikita-volkov/list-t) | ListT done right
...
*   dev-haskell/[mtl-prelude](https://github.com/nikita-volkov/mtl-prelude) | Reexports of most definitions from mtl and transformers
*   dev-haskell/[neat-interpolation](https://github.com/nikita-volkov/neat-interpolation) | Quasiquoter for neat and simple multiline text interpolation
...
*   dev-haskell/[optional-args](https://hackage.haskell.org/package/optional-args) | Optional function arguments
...
*   dev-haskell/[polyparse](https://github.com/haskell-pkg-janitors/polyparse) | A variety of alternative parser combinator libraries
...
*   dev-haskell/[prometheus-client](https://github.com/fimad/prometheus-haskell) | Haskell client library for exposing prometheus.io metrics
*   dev-haskell/[prometheus-metrics-ghc](https://github.com/fimad/prometheus-haskell) | Haskell client library for exposing prometheus.io metrics
...
*   dev-haskell/[puresat](https://github.com/phadej/puresat) | Pure Haskell SAT-solver
*   dev-haskell/[ram](https://github.com/jappeace/ram) | memory and related abstraction stuff
*   dev-haskell/[random-shuffle](https://hackage.haskell.org/package/random-shuffle) | Random shuffle implementation
...
*   dev-haskell/[text-builder-core](https://github.com/nikita-volkov/text-builder-core) | Internals of text-builder
...
*   dev-haskell/[testcontainers](https://github.com/testcontainers/testcontainers-hs) | Docker containers for your integration tests
*   dev-haskell/[testcontainers-postgresql](https://github.com/nikita-volkov/testcontainers-postgresql) | Testcontainers integration for PostgreSQL
...
*   dev-haskell/[turtle](https://hackage.haskell.org/package/turtle) | Shell programming, Haskell-style
...
*   dev-java/[classgraph](https://github.com/classgraph/classgraph) | An uber-fast parallelized Java classpath scanner and module scanner
...
*   dev-java/[jetty-util](https://github.com/jetty/jetty.project) | Common utility library for Eclipse Jetty
*   dev-java/[tomcat-api](https://tomcat.apache.org/) | Core Apache Tomcat interfaces and classes
*   dev-java/[tomcat-el-api](https://tomcat.apache.org/) | Apache Tomcat EL API
*   dev-java/[tomcat-embed-el](https://tomcat.apache.org/) | Apache Tomcat embedded Expression Language engine
*   dev-java/[tomcat-jasper](https://tomcat.apache.org/) | Apache Tomcat Jasper JSP engine
*   dev-java/[tomcat-jasper-el](https://tomcat.apache.org/) | Apache Tomcat Jasper Expression Language engine
*   dev-java/[tomcat-jsp-api](https://tomcat.apache.org/) | Apache Tomcat JSP API
*   dev-java/[tomcat-juli](https://tomcat.apache.org/) | Apache Tomcat JULI logging implementation
...
*   dev-libs/[intel-dfp](https://www.intel.com/content/www/us/en/developer/articles/tool/intel-decimal-floating-point-math-library.html) | Intel Decimal Floating-Point Math Library
...
*   dev-libs/[qmltermwidget](https://github.com/Swordfish90/qmltermwidget) | QML port of qtermwidget
...
*   dev-ml/[awa](https://github.com/mirage/awa-ssh) | Purely functional SSH library in OCaml
...
*   dev-ml/[cmarkit](https://github.com/dbuenzli/cmarkit) | CommonMark parser and renderer for OCaml
...
*   dev-ml/[diet](https://github.com/mirage/ocaml-diet) | Ocaml Discrete Interval Encoding Trees
...
*   dev-ml/[dns-stub](https://github.com/mirage/ocaml-dns) | OCaml implementation of the DNS protocol
*   dev-ml/[dune-rpc](https://github.com/ocaml/dune) | Communicate with dune using rpc
...
*   dev-ml/[h1](https://github.com/robur-coop/ocaml-h1) | A scalable web server for OCaml
...
*   dev-ml/[ke](https://github.com/mirage/ke) | Fast implementation of queue in OCaml
...
*   dev-ml/[lsp](https://github.com/ocaml/ocaml-lsp) | OCaml Language Server Protocol implementation
...
*   dev-ml/[mimic](https://github.com/dinosaure/mimic) | A simple protocol dispatcher
...
*   dev-ml/[mirage-ptime](https://github.com/mirage/mirage-ptime) | POSIX time functions for MirageOS
*   dev-ml/[mirage-sleep](https://github.com/mirage/mirage-sleep) | Sleep operation for MirageOS
...
*   dev-ml/[mosaic](https://github.com/invariant-hq/mosaic) | Terminal user interfaces for OCaml
...
*   dev-ml/[opentelemetry](https://github.com/ocaml-tracing/ocaml-opentelemetry) | Instrumentation and serialization for opentelemetry
...
*   dev-ml/[xdg](https://github.com/ocaml/dune) | XDG Base Directory Specification
...
*   dev-php/[brick-math](https://github.com/brick/math) | Arbitrary-precision arithmetic library for PHP
...
*   dev-php/[http2jp-hpack-test-case](https://github.com/http2jp/hpack-test-case) | HPACK Test Case
...
*   dev-php/[json-schema-test-suite](https://github.com/json-schema-org/JSON-Schema-Test-Suite) | A language agnostic test suite for the JSON Schema specifications
*   dev-php/[justinrainbow-json-schema](https://github.com/jsonrainbow/json-schema) | JSON Schema for PHP
...
*   dev-php/[marc-mabe-php-enum](https://github.com/marc-mabe/php-enum) | Simple and fast implementation of enumerations with native PHP
...
*   dev-php/[phar-io-manifest](https://github.com/phar-io/manifest) | Reading phar.io manifest information from a PHP Archive (PHAR)
...
*   dev-php/[phpspec-prophecy](https://github.com/phpspec/prophecy) | Highly opinionated mocking framework for PHP
*   dev-php/[phpspec-prophecy-phpunit](https://github.com/phpspec/prophecy-phpunit) | Integrating Prophecy in PHPUnit test cases
...
*   dev-php/[relay](https://relay.so) | High-performance Redis client and shared in-memory cache for PHP
...
*   dev-php/[sebastian-complexity](https://github.com/sebastianbergmann/complexity) | Library for calculating the complexity of PHP code units
*   dev-php/[sebastian-diff](https://github.com/sebastianbergmann/diff) | PHP Diff implementation
*   dev-php/[sebastian-environment](https://github.com/sebastianbergmann/environment) | PHP code that has runtime-specific execution paths
...
*   dev-php/[sebastian-lines-of-code](https://github.com/sebastianbergmann/lines-of-code) | Library for counting the lines of code in PHP source code
...
*   dev-php/[spomky-labs-pki-framework](https://github.com/spomky-labs/pki-framework) | Public Key Infrastructure
...
*   dev-php/[symfony-polyfill-php85](https://github.com/symfony/polyfill-php85) | Backport of some PHP 8.5+ features to lower PHP versions
...
*   dev-php/[ulrichsg-getopt-php](https://github.com/getopt-php/getopt-php) | A PHP library for command-line argument processing
*   dev-php/[web-token-jwt-library](https://github.com/web-token/jwt-library) | PHP JWT Library
...
*   dev-python/[annotated-doc](https://github.com/fastapi/annotated-doc) | Document parameters, class attributes and variables inline
...
*   dev-python/[certipy-ad](https://github.com/ly4k/Certipy) | Active Directory Certificate Services enumeration and abuse
*   dev-python/[channels](https://github.com/django/channels) | Brings async, event-driven capabilities to Django
*   dev-python/[chalice](https://github.com/aws/chalice) | Python Serverless Microframework for AWS
...
*   dev-python/[daff](https://github.com/paulfitz/daff) | Diff and patch tables
...
*   dev-python/[dbt-adapters](https://github.com/dbt-labs/dbt-adapters) | The set of adapter protocols and base functionality for dbt-core
*   dev-python/[dbt-common](https://github.com/dbt-labs/dbt-common) | The shared common utilities for dbt
...
*   dev-python/[filecheck](https://github.com/AntonLydike/filecheck) | A Python-native clone of LLVMs FileCheck tool
...
*   dev-python/[readchar](https://github.com/magmax/python-readchar) | Python library to read characters and key strokes
...
*   dev-python/[snowplow-tracker](https://github.com/snowplow/snowplow-python-tracker) | Snowplow event tracker for Python
...
*   dev-util/[bats-assert](https://github.com/bats-core/bats-assert) | Common assertions for Bats
*   dev-util/[bats-detik](https://github.com/bats-core/bats-detik) | A library to ease e2e tests of applications in K8s environments
*   dev-util/[bats-file](https://github.com/bats-core/bats-file) | Common filesystem assertions for Bats
*   dev-util/[bats-support](https://github.com/bats-core/bats-support) | Supporting library for Bats test helpers
...
*   dev-util/[codex](https://github.com/openai/codex) | Lightweight coding agent that runs in your terminal
...
*   dev-util/[wasmtime](https://github.com/bytecodealliance/wasmtime) | A lightweight WebAssembly runtime
...
*   kde-misc/[plasma-applet-ambientnoise](https://github.com/m-pilia/plasma-applet-ambientnoise) | Plasma widget for play ambient noise
...
*   media-video/[mediamtx](https://github.com/bluenviron/mediamtx) | SRT / WebRTC / RTSP / RTMP / LL-HLS / MPEG-TS / RTP media server
...
*   net-misc/[stargazer](https://stg.net.ua) | Billing system for small home and office networks
...
*   www-misc/[httraqt](https://httraqt.sourceforge.net) | Graphical user interface for HTTrack library, developed in C++ and based on Qt
...
*   www-servers/[freeunit](https://github.com/freeunitorg/freeunit) | Dynamic web and application server
...
*   www-servers/[weblist](https://github.com/umputun/weblist) | A modern, elegant file browser for the web
...
*   x11-terms/[cool-retro-term](https://github.com/Swordfish90/cool-retro-term) | A terminal emulator which mimics the old cathode display
*   x11-themes/[dashboard-icons](https://github.com/homarr-labs/dashboard-icons) | SVG icons for popular brands
*   x11-themes/[simple-icons](https://github.com/simple-icons/simple-icons) | SVG icons for popular brands
