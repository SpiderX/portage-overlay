...
EGO_SUM=(
	...
	"github.com/containers/image/v5 v5.24.2/go.mod"
	"github.com/containers/libtrust v0.0.0-20230121012942-c1716e8a8d01"
	"github.com/containers/libtrust v0.0.0-20230121012942-c1716e8a8d01/go.mod"
	"github.com/containers/ocicrypt v1.1.7"
	"github.com/containers/ocicrypt v1.1.7/go.mod"
	"github.com/containers/storage v1.45.3"
	"github.com/containers/storage v1.45.3/go.mod"
	...
	"github.com/docker/docker v23.0.2+incompatible/go.mod"
	...
	"github.com/go-openapi/runtime v0.24.1/go.mod"
	...
	"github.com/go-openapi/strfmt v0.21.2/go.mod"
	...
	"github.com/klauspost/pgzip v1.2.6-0.20220930104621-17e8dac29df8/go.mod"
	...
	"github.com/letsencrypt/boulder v0.0.0-20221109233200-85aa52084eaf/go.mod"
	...
	"github.com/opencontainers/runc v1.1.4/go.mod"
	...
	"github.com/proglottis/gpgme v0.1.3/go.mod"
	"github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.64.0"
	"github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.64.0/go.mod"
	...
	"github.com/sigstore/fulcio v1.0.0/go.mod"
	"github.com/sigstore/rekor v1.0.1"
	"github.com/sigstore/rekor v1.0.1/go.mod"
	"github.com/sigstore/sigstore v1.5.1"
	"github.com/sigstore/sigstore v1.5.1/go.mod"
	...
	"github.com/theupdateframework/go-tuf v0.5.2-0.20221207161717-9cb61d6e65f5/go.mod"
	...
	"github.com/vbauerster/mpb/v7 v7.5.3/go.mod"
	...
	"go.mongodb.org/mongo-driver v1.11.1/go.mod"
