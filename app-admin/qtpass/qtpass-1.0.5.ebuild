...
src_prepare() {
	...
	# Backport segfault fix https://github.com/IJHack/qtpass/issues/122 (ToDo: remove this in 1.0.6)
	sed -i "/QtPass = NULL;/{n;d};/startupPhase = true;/a autoclearTimer = NULL;" mainwindow.cpp || die "sed failed mainwindow.cpp"
