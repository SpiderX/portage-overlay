...
EGO_SUM=(
	...
	"github.com/Azure/azure-sdk-for-go/sdk/azcore v1.1.0/go.mod"
	...
	"github.com/Azure/azure-sdk-for-go/sdk/storage/azblob v0.4.1/go.mod"
	...
	"github.com/go-mysql-org/go-mysql v1.7.0/go.mod"
	...
	"github.com/mongodb/mongo-tools v0.0.0-20240724183527-6d4f001be3fc/go.mod"
	...
	"github.com/pingcap/errors v0.11.5-0.20210425183316-da1aaba5fb63/go.mod"
	"github.com/pingcap/log v0.0.0-20210625125904-98ed8e2eb1c7/go.mod"
	"github.com/pingcap/tidb/parser v0.0.0-20221126021158-6b02a5d8ba7d/go.mod"
	...
	"github.com/wal-g/tracelog v0.1.1/go.mod"
	...
	"github.com/yandex-cloud/go-genproto v0.0.0-20230918115514-93a99045c9de/go.mod"
	"github.com/yandex-cloud/go-sdk v0.0.0-20230918120620-9e95f0816d79"
	"github.com/yandex-cloud/go-sdk v0.0.0-20230918120620-9e95f0816d79/go.mod"
	...
	"modernc.org/parser v1.0.0/go.mod"
	"modernc.org/parser v1.0.2/go.mod"
	"modernc.org/scanner v1.0.1/go.mod"
	"modernc.org/sortutil v1.0.0/go.mod"
	"modernc.org/strutil v1.0.0/go.mod"
	"modernc.org/strutil v1.1.0/go.mod"
	"modernc.org/y v1.0.1/go.mod"
