...
COMMIT="37f3bd78adec2aadc1de10f9323fe426a5e12dc4"
EGO_SUM=(
	...
	"github.com/Azure/azure-storage-blob-go v0.10.1-0.20200807102407-24fe552e0870/go.mod"
	...
	"github.com/ClickHouse/clickhouse-go v1.4.5/go.mod"
	...
	"github.com/aws/aws-sdk-go v1.37.15/go.mod"
	...
	"github.com/jlaffaye/ftp v0.0.0-20200730135723-c2ee4fa2503b/go.mod"
	...
	"github.com/klauspost/compress v1.7.4/go.mod"
	...
	"github.com/mholt/archiver v1.1.3-0.20190812163345-2d1449806793/go.mod"
	...
	"github.com/tencentyun/cos-go-sdk-v5 v0.0.0-20200120023323-87ff3bc489ac/go.mod"
	...
	"gopkg.in/djherbis/buffer.v1 v1.1.0/go.mod"
	"gopkg.in/djherbis/nio.v2 v2.0.3"
	"gopkg.in/djherbis/nio.v2 v2.0.3/go.mod"
...
SRC_URI="https://github.com/AlexAkulov/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
