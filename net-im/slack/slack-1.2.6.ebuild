...
LICENSE="UNKNOWN"
#SRC_URI_AMD64="https://slack-ssb-updates.global.ssl.fastly.net/linux_releases/${PN}-desktop-${PV}-amd64.deb"
#SRC_URI_X86="https://slack-ssb-updates.global.ssl.fastly.net/linux_releases/${PN}-desktop-${PV}-i386.deb"
#SRC_URI="
#	amd64? ( ${SRC_URI_AMD64} )
#	x86? ( ${SRC_URI_X86} )
#"
