...
EGO_SUM=(
	...
	"github.com/alecthomas/chroma/v2 v2.5.0/go.mod"
	...
	"github.com/billgraziano/dpapi v0.4.0/go.mod"
	...
	"github.com/subosito/gotenv v1.4.1/go.mod"
	...
	"golang.org/x/sys v0.0.0-20200828161417-c663848e9a16/go.mod"
	...
	"google.golang.org/genproto/googleapis/api v0.0.0-20250425173222-7b384671a197/go.mod"
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20250425173222-7b384671a197"
	"google.golang.org/genproto/googleapis/rpc v0.0.0-20250425173222-7b384671a197/go.mod"
...
SRC_URI="https://github.com/microsoft/go-sqlcmd/archive/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
